                ...
                <main-layout>
                    <section>
                        <div class="mb-6 article__content">
                            <section-header v-if="$root.isTablet" class="mb-6">
                                Disclaimer
                            </section-header>
...
<ul>
<li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Disclaimer) refers to Urbancruise.</li>
<li><strong>Service</strong> refers to the Website.</li>
<li><strong>You</strong> means the individual accessing the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
<li><strong>Website</strong> refers to Urbancruise, accessible from <a href="Http://urbancruise.com.ng" rel="external nofollow noopener" target="_blank">Http://urbancruise.com.ng</a></li>
</ul>
<h1>Disclaimer</h1>
...
<ul>
<li>By email: Urbancruisedaily@gmail.com</li>
</ul>
                        </div>
                    </section>
